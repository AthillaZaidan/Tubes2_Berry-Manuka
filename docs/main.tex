...
% Header berisi logo + 3 baris teks, jadi headheight harus cukup besar agar tidak terpotong.
...
\begin{document}
	...
	\input{sections/03-aplikasi-bfs-dfs}
	
	\chapter{Implementasi}
	\input{sections/04-implementasi-pengujian}
